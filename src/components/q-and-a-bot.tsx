    ...
    <div className="space-y-6">
      ...
      >
        ...
        <p className="text-muted-foreground">
          Ask questions about any product and get instant AI-powered answers
        </p>
      </motion.div>
        ...
        <div className="flex flex-col sm:flex-row gap-4">
          ...
          {selectedProduct && (
            <motion.div
              ...
              className="flex items-center gap-3 p-4 bg-gradient-to-r from-purple-50 to-blue-50 dark:from-purple-900/20 dark:to-blue-900/20 rounded-xl border border-purple-200 dark:border-purple-800"
            >
              <div className="w-12 h-12 rounded-lg overflow-hidden border-2 border-white dark:border-gray-700 shadow-md">
                <img 
            ...
            <AnimatePresence>
              ...
              {messages.map((message, index) => (
                ...
                >
                  ...
                  <motion.div
                    ...
                    className={cn(
                      "max-w-xs md:max-w-md rounded-2xl p-4 text-sm shadow-sm",
                      message.sender === "user"
              ...
              {isPending && (
                ...
                >
                  ...
                  <div className="bg-gray-100 dark:bg-gray-700 rounded-2xl p-4 flex items-center space-x-2">
        ...
        <div className="p-4 border-t border-gray-200 dark:border-gray-700 bg-gray-50 dark:bg-gray-900/50">
          <div className="flex items-center gap-2">
            <Input
              ...
              className="flex-1 bg-white dark:bg-gray-800 border-2 border-gray-200 dark:border-gray-700 focus:border-purple-500 dark:focus:border-purple-400 transition-all duration-300"
            />
            <Button 
              onClick={handleSend} 
              disabled={isPending || !selectedProductId}
